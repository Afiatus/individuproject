    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Home<b>Stay.com</b></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/book.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px;">
        <h2><b>Selamat datang di <h1>Home<b>stay.com</b></h1></h2>
        <p>disini anda bisa memesan villa dengan mudah.</p>
      </div>
    </div>
    </div>
